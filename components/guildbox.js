...
export default function GuildBox({ guild }) {
    ...
    const { data: sharesData } = useStarknetCall({ contract: certificateContract, method: 'get_shares', args: [certificate_id ? certificate_id.token_id : 0] });
    ...
    return (
        <Link href={"/panel/" + guildContractAddress}>
            <div className={styles.box}>
                <img className={styles.img} src="/illustrations/warrior2.webp" alt="A warrior" />
                <div className={styles.content}>
                    <h1 className={styles.name}>{nameData ? feltToString(nameData.name) : "Loading..."}</h1>
                    <div className={styles.description}>
                        ...
                        <div className={styles.descline} >
                            ...
                            You hold the title of {titleData ? feltToString(titleData.value) : "Loading..."}
                        </div>
                        ...
                        <div className={styles.descline} >
                            ...
                            You own {sharesData ? "7" : "..."} guild shares out of {totalShares}
                        </div>
                        ...
                        <div className={styles.descline} >
                            ...
                            This guild is connected to {extensionsData ? extensionsData.nb.toString() : "..."} games
                        </div>
