                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.description}>
                        ...
                        <div className={styles.descline} >
                            ...
                            You own {shares} guild shares, that is {(100 * shares / totalShares).toFixed(2)}% of the total voting power
                        </div>
                        ...
                        <div className={styles.descline} >
                            ...
                            This guild is connected to {extensions} games
                        </div>
